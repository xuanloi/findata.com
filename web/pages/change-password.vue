...
export default {
    ...
    watch: {
        ...
        'connection1.getupdateStatus' : function(newVal) {
            if(newVal) {
                ...
                let self = this
                mixing.delay(function(){self.login = undefined
    ...
    methods: {
        checkLogin() {
            ...
            this.account = this.connection.getbatchData.find(v => v.name==="login").data
            ...
            else if(this.account.enable === false) {
                this.errList.push('email')
            ...
            this.connection1.update('accountlist', this.account)
        },
